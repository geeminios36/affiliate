    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">Momo Credential</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="MOMO_PARTNER_CODE">
                            <div class="col-md-4">
                                <label class="col-from-label">PARTNER CODE</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="MOMO_PARTNER_CODE" value="{{  env('MOMO_PARTNER_CODE') }}" placeholder="PARTNER CODE" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ACCESS_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">ACCESS KEY</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="ACCESS_KEY" value="{{  env('ACCESS_KEY') }}" placeholder="ACCESS KEY" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="MOMO_SECRET_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">SECRET KEY</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="MOMO_SECRET_KEY" value="{{  env('MOMO_SECRET_KEY') }}" placeholder="SECRET KEY" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">Momo Sandbox Mode</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="momo_sandbox" type="checkbox" @if (get_setting('momo_sandbox') == 1)
                                    checked
                                        @endif>
                                    <span class="slider round"></span>
                                </label>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">VNPay Credential</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="VNPAY_TERMINAL_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">TERMINAL ID</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="VNPAY_TERMINAL_ID" value="{{  env('VNPAY_TERMINAL_ID') }}" placeholder="TERMINAL ID" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="VNPAY_SECRET_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">SECRET KEY</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="VNPAY_SECRET_KEY" value="{{  env('VNPAY_SECRET_KEY') }}" placeholder="SECRET KEY" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">VNPay Sandbox Mode</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="vnpay_sandbox" type="checkbox" @if (get_setting('vnpay_sandbox') == 1)
                                    checked
                                        @endif>
                                    <span class="slider round"></span>
                                </label>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">AppotaPay Credential</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        <input type="hidden" name="payment_method" value="appotapay">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="APPOTAPAY_PARTNER_CODE">
                            <div class="col-md-4">
                                <label class="col-from-label">PARTNER CODE</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="APPOTAPAY_PARTNER_CODE" value="{{  env('APPOTAPAY_PARTNER_CODE') }}" placeholder="PARTNER CODE" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="APPOTAPAY_API_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">API KEY</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="APPOTAPAY_API_KEY" value="{{  env('APPOTAPAY_API_KEY') }}" placeholder="API KEY" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="APPOTAPAY_SECRET_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">SECRET KEY</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="APPOTAPAY_SECRET_KEY" value="{{  env('APPOTAPAY_SECRET_KEY') }}" placeholder="SECRET KEY" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="APPOTAPAY_PUBLIC_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">PUBLIC KEY</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="APPOTAPAY_PUBLIC_KEY" value="{{  env('APPOTAPAY_PUBLIC_KEY') }}" placeholder="PUBLIC KEY" >
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">APPOTAPAY Sandbox Mode</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="appotapay_sandbox" type="checkbox" @if (get_setting('appotapay_sandbox') == 1)
                                    checked
                                        @endif>
                                    <span class="slider round"></span>
                                </label>
