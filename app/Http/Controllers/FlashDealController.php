...
class FlashDealController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $flash_deal->tenacy_id = get_tenacy_id_for_query();
        if($flash_deal->save()){
            foreach ($request->products as $key => $product) {
                ...
                $root_product = Product::where('id', $product)->first();
    ...
    public function destroy($id)
    {
        ...
        FlashDeal::where('id', $id)->where('tenacy_id', get_tenacy_id_for_query())->delete();
    ...
    {
        $flash_deal = FlashDeal::where('id', $request->id)->first();
