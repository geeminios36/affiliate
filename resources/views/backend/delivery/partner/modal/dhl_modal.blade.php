<div class="modal" id="dhl_modal_connect" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class=" modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document"
        ...
        <div class="modal-content position-relative">
                ...
                <div class="form-group">
                    <div class="add-channel-modal__learn-more">
                        <div class="image-connect">
                            <img style="width: 30%"
                                src="{{static_asset('assets/img/delivery/dhl.png')}}"
                                class="icon-dhl">
                        </div>
                        <div id="input_token_dhl">
                                ...
                                <div class="ui-stack ui-stack--wrap">
                                    <div class="ui-stack-item ui-stack-item--fill">
                                        <div class="next-input-wrapper">
                                            <input type="text" class="form-control" id="token_key_dhl"
                                                   autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <p style="margin-top:5px;">Bạn chưa có tài khoản? <a
                                        href="https://khachhang.dhl.vn/" target="_blank" rel="nofollow"
                            ...
                            <div style="margin-top:10px;">
                                ...
                                <p style="color:#08f">&gt;&gt; <a href="https://dhl.vn/" class="delivery-link" target="_blank" rel="nofollow">
                                        Tìm hiểu thêm về Giao hàng nhanh
                                    </a></p>
                            </div>
                        </div>
                        <div id="save_token_dhl">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-primary fw-600" id="dhl_modal_connect_dismiss"
                        data-dismiss="modal">{{translate('Cancel')}}</button>
                <button type="submit" class="btn btn-primary fw-600" id="dhl_modal_connect_submit"
                        onclick="getStoreDataDelivery('{{config('constants.dhl')}}')">Tiếp theo
                </button>
            </div>
        </div>
    </div>
