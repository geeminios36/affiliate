            ...
            <div class="d-flex align-items-start">
                ...
                <div class="aiz-user-panel">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="" action="{{route('refund_request_send', $order_detail->id)}}" method="POST"
                                ...
                                <div class="form-box bg-white mt-4">
                                    <div class="form-box-content p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control mb-3" name="name"
                                                       ...
                                                       value="{{ $order_detail->product->getTranslation('name') }}"
                                                       readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control mb-3" name="name"
                                                       placeholder="{{translate('Product Price')}}"
                                                       value="{{ $order_detail->product->unit_price }}" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control mb-3" name="code"
                                                       value="{{ $order_detail->order->code }}" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group mb-0 text-right">
                                            <button type="submit"
                                                    class="btn btn-primary">{{translate('Send Request')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
