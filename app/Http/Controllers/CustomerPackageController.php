...
class CustomerPackageController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        CustomerPackage::where('id', $id)->where('tenacy_id', get_tenacy_id_for_query())->delete();
    ...
    public function purchase_payment_done($payment_data, $payment)
    {
        ...
        $customer_package = CustomerPackage::where('id', $payment_data['customer_package_id'])->first();
