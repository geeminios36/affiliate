                    ...
                    <div class="single-blog-item mt-30">
                        <div class="blog-thumbnail-box">
                            <a href="#" class="thumbnail">
                                <img src="{{ uploaded_asset($blog->banner) ?? 'assets/frontend/images/blog/8-570x370.webp' }}"
                        ...
                        <div class="blog-contents">
                            <h6 class="blog-title"><a
                                    href="#">{{ $blog->title }}</a></h6>
                            <div class="meta-tag-box">
                                <div class="meta date">
                                    <span>{{ date('H:i d/m/Y', strtotime($blog->created_at)) }}</span>
                                </div>
                                {{--                                <div class="meta author"><span><a href="#">Hastheme</a></span></div> --}}
                                @if ($blog->category != null)
                                    <div class="meta cat">
                                        <span>in <a
                                                href="#">{{ $blog->category->category_name }}</a></span>
                                    </div>
                                @endif
                            </div>
                        </div>
