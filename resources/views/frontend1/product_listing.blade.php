                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            @else
                                                ...
                                                @foreach (\App\Utility\CategoryUtility::get_immediate_children_ids($category_id) as $key => $id)
                                                    <li class="ml-4 mb-2">
                                                        <a class="text-reset fs-14"
                                                           href="{{ route('products.category', \App\Category::where('id', $id)->first()->slug) }}">{{ \App\Category::where('id', $id)->first()->getTranslation('name') }}</a>
                                                    </li>
                                                @endforeach
                                            @endif
                                        </ul>
                                        ...
                                        <div class="aiz-range-slider">
                                            @if(empty($category_ids))
                                                <div
                                                    ...
                                                    data-range-value-min="{{ filter_products(\App\Product::query())->get()->min('unit_price') }}"
                                                    data-range-value-max="{{ filter_products(\App\Product::query())->get()->max('unit_price') }}"
                                                ></div>
                                            @else
                                                <div
                                                    id="input-slider-range"
                                                    data-range-value-min="{{ filter_products(\App\Product::query())->whereIn('category_id', $category_ids)->get()->min('unit_price') }}"
                                                    data-range-value-max="{{ filter_products(\App\Product::query())->whereIn('category_id', $category_ids)->get()->max('unit_price') }}"
                                                ></div>
                                            @endif
                        ...
                        <ul class="breadcrumb bg-transparent p-0">
                            ...
                            @if(isset($category_id))
                                <li class="text-dark fw-600 breadcrumb-item">
                                    <a class="text-reset"
                                       href="{{ route('products.category', \App\Category::find($category_id)->slug) }}">"{{ \App\Category::find($category_id)->getTranslation('name') }}
                                        "</a>
                                </li>
                            @endif
                        </ul>
