...
class AizUploadController extends Controller
{
    ...
    public function destroy(Request $request,$id)
    {
        try{
            ...
            //     Storage::disk('wasabi')->delete(Upload::where('id', $id)->first()->file_name);
            // }
            // else{
            //     unlink(public_path().'/'.Upload::where('id', $id)->first()->file_name);
            // }
            Upload::where('id', $id)->where('tenacy_id', get_tenacy_id_for_query())->delete();
    ...
    {
        $project_attachment = Upload::where('id', $id)->first();
        try{
