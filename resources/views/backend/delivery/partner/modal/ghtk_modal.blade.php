<div class="modal" id="ghtk_modal_connect" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class=" modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document"
        ...
        <div class="modal-content position-relative">
                ...
                <div class="form-group">
                    <div class="add-channel-modal__learn-more">
                        <div class="image-connect">
                            <img
                                src="{{static_asset('assets/img/delivery/ghtk.png')}}"
                                class="icon-ghtk">
                        </div>
                        <div id="input_token_ghtk">
                            <p style="margin:12px 0;"> Sell Express kết nối 2 chiều với đối tác Giao hàng tiết kiệm
                                2 giúp cửa
                                hàng:</p>
                            ...
                            <div>
                                <p style="margin-bottom:10px"><strong>Điền mã Token tài khoản Giao hàng tiết kiệm</strong></p>
                                <div class="ui-stack ui-stack--wrap">
                                    <div class="ui-stack-item ui-stack-item--fill">
                                        <div class="next-input-wrapper">
                                            <input type="text" class="form-control" id="token_key_ghtk"
                                                   autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <p style="margin-top:5px;">Bạn chưa có tài khoản? <a
                                        href="https://khachhang.giaohangtietkiem.vn/" target="_blank" rel="nofollow"
                            ...
                            <div style="margin-top:10px;">
                                ...
                                <p style="color:#08f">&gt;&gt; <a href="https://giaohangtietkiem.vn/" class="delivery-link" target="_blank" rel="nofollow">
                                        Tìm hiểu thêm về Giao hàng tiết kiệm
                                    </a></p>
                            </div>
                        </div>
                        <div id="save_token_ghtk">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-primary fw-600" id="ghtk_modal_connect_dismiss"
                        data-dismiss="modal">{{translate('Cancel')}}</button>
                <button type="submit" class="btn btn-primary fw-600" id="ghtk_modal_connect_submit"
                        onclick="getStoreDataDelivery('ghtk')">Tiếp theo
                </button>
            </div>
        </div>
    </div>
