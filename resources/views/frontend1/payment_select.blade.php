                                    ...
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        <div class="row gutters-10">
                                            @if(get_setting('momo') == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="momo" class="online_payment" type="radio"
                                                               name="payment_option" checked>
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/momo_logo.png')}}"
                                                             class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{translate('Momo')}}</span>
                                                        </span>
                                                    </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="vnpay" class="online_payment"
                                                               onclick="toggleManualPaymentData('vnpay')" type="radio"
                                                               name="payment_option" checked>
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/vnpay.png')}}"
                                                             class="img-fluid mb-2" style="padding: 17px 0px;">
                                                        <span class="d-block text-center">
                                            ...
                                            @if(get_setting('appotapay') == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="appotapay" class="online_payment"
                                                               onclick="toggleManualPaymentData('appotapay')"
                                                               type="radio" name="payment_option" checked>
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/appotapay.png')}}"
                                                             class="img-fluid mb-2"
                                                             style="padding: 17px 0px; background: #349241 !important; border: 3px solid #349241; border-radius: 5px">
                                                        <span class="d-block text-center">
                                            ...
                                            @if(get_setting('proxypay') == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="proxypay" class="online_payment" type="radio"
                                                               name="payment_option" checked>
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                        ...
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{translate('ProxyPay')}}</span>
                                                        </span>
                                                    </span>
                                                    </label>
                                                </div>
