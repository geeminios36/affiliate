...
class CustomerProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $customer_product->tenacy_id = get_tenacy_id_for_query();
    ...
    {
        $customer_product                       = CustomerProduct::where('id', $id)->first();
    ...
    public function destroy($id)
    {
        ...
        if (CustomerProduct::where('id', $id)->where('tenacy_id', get_tenacy_id_for_query())->delete()) {
    ...
    {
        $product = CustomerProduct::where('id', $request->id)->first();
