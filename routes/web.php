...
Route::delete('/aiz-uploader/destroy/{id}', 'AizUploadController@delete')->name('delete_attachment');
...
Route::group(['middleware' => ['checkout']], function () {
    ...
    Route::get('/checkout/momo', 'CheckoutController@resultMomo')->name('checkout.momo');;
    Route::get('/checkout/vnpay', 'CheckoutController@resultVNPay')->name('checkout.vnpay');;
    Route::get('/checkout/appota', 'CheckoutController@resultAppotaPay')->name('checkout.appota');;
});
