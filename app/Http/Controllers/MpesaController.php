...
class MpesaController extends Controller
{
    ...
    public function pay()
    {
        if(Session::has('payment_type')){
            ...
            elseif (Session::get('payment_type') == 'customer_package_payment') {
                ...
                $customer_package  = CustomerPackage::where('id', $customer_package_id)->first();
            ...
            elseif (Session::get('payment_type') == 'seller_package_payment') {
                ...
                $seller_package  = \App\SellerPackage::where('id', $seller_package_id)->first();
    ...
    public function payment_complete(Request $request)
    {
        ...
        if(Session::has('order_id')) {
            ...
            $customer_package_price = CustomerPackage::where('id', $customer_package_id)->first()->amount;
            ...
            $seller_package_price = \App\SellerPackage::where('id', $seller_package_id)->first()->amount;
