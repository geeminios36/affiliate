...
<section class="mb-4">
                ...
                <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST" id="checkout-form">
                    ...
                    <div class="card shadow-sm border-0 rounded">
                        ...
                        <div class="card-body text-center">
                            <div class="row">
                                <div class="col-xxl-8 col-xl-10 mx-auto">
                                    <div class="row gutters-10">
                                        @if(get_setting('momo') == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="momo" class="online_payment" type="radio" name="payment_option" checked>
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/momo_logo.png')}}" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{translate('Momo')}}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                        ...
                                        @if(get_setting('vnpay') == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3" >
                                                    <input value="vnpay" class="online_payment" onclick="toggleManualPaymentData('vnpay')" type="radio" name="payment_option" checked>
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/vnpay.png')}}" class="img-fluid mb-2" style="padding: 17px 0px;">
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">VNPAY</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                        ...
                                        @if(get_setting('appotapay') == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3" >
                                                    <input value="appotapay" class="online_payment" onclick="toggleManualPaymentData('appotapay')" type="radio" name="payment_option" checked>
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/appotapay.png')}}" class="img-fluid mb-2" style="padding: 17px 0px; background: #349241 !important; border: 3px solid #349241; border-radius: 5px" >
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">AppotaPay</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                            ...
                            @endif
                            <div class="bg-white border mb-3 p-3 rounded text-left d-none">
                                <div id="other_payment_description">
    ...
    <form id="frmCreateOrderVNPay" class="d-none">
        <div class="form-group">
            <label for="OrderDescription">Nội dung thanh toán</label>
            <textarea class="form-control" cols="20" id="OrderDescription" name="OrderDescription" rows="2">Thanh toan don hang thoi gian: {{\Illuminate\Support\Carbon::now()->format('d/m/Y H:i:s')}}</textarea>
        </div>

        <div class="form-group">
            <label for="bankcode">Ngân hàng</label>
            <select class="form-control " data-live-search="true"  id="bankcode" name="bankcode">
    ...
    <form id="frmCreateOrderAppotaPay" class="d-none">
        <div class="form-group">
            <label for="OrderDescription">Nội dung thanh toán</label>
            <textarea class="form-control" cols="20" id="OrderDescriptionAppotaPay" name="OrderDescription" rows="2">Thanh toan don hang thoi gian: {{\Illuminate\Support\Carbon::now()->format('d/m/Y H:i:s')}}</textarea>
        </div>

        <div class="form-group">
            <label for="paymentMethod">Phương thức thanh toán</label>
            <select class="form-control " data-live-search="true"  id="paymentMethodAppotaPay" name="paymentMethod">
                <option value="" disabled selected>Chọn phương thức</option>
                <option value="ATM">Thanh toán qua iBanking/thẻ ATM</option>
                <option value="CC">Thanh toán qua thẻ Visa/Master Card/JCB</option>
        ...
        <div class="form-group">
            <label for="bankCode">Ngân hàng</label>
            <select class="form-control " data-live-search="true"  id="bankCodeAppotaPay" name="bankCode">
                <option value="" selected disabled>Không chọn </option>
                <option value="VCB">Ngân hàng Vietcombank</option>
                <option value="TECHCOMBANK">Ngân hàng Techcombank</option>
                <option value="TPBANK">Ngân hàng TienphongBank</option>
                <option value="VIETINBANK">Ngân hàng Vietinbank</option>
                <option value="VIB">Ngân hàng VIBank</option>
                <option value="DAB">Ngân hàng Dong A Bank</option>
                <option value="HDBANK">Ngân hàng HD Bank</option>
                <option value="MB">Ngân hàng MB</option>
                <option value="VIETABANK">Ngân hàng Việt Á Bank	</option>
                <option value="MARITIMEBANK">Ngân hàng MARITIMEBANK</option>
                <option value="EXIMBANK">Ngân hàng EximBank</option>
                <option value="SHB">Ngân hàng SHB</option>
                <option value="VPBANK">Ngân hàng VP Bank</option>
                <option value="ABBANK">Ngân hàng AB Bank  </option>
                <option value="SACOMBANK">Ngân hàng Sacombank </option>
                <option value="NAMA">Ngân hàng Nam A Bank </option>
                <option value="OCEANBANK">Ngân hàng OceanBank </option>
                <option value="BIDV"> Vi dien tu BIDV</option>
                <option value="SEABANK">Ngân hàng SeaBank</option>
                <option value="BACA">Ngân hàng Bắc A</option>
                <option value="NAVIBANK">Ngân hàng NaviBank</option>
                <option value="AGRIBANK">Ngân hàng Agribank</option>
                <option value="SAIGONBANK">Ngân hàng TMCP Sài Gòn (SCB)</option>
                <option value="PVBANK">PVcombank</option>
                <option value="ACB">Ngân hàng ACB</option>
                <option value="LPB">Ngân hàng Bưu Điện</option>
                <option value="BVBANK">Ngân hàng Bảo Việt</option>
                <option value="OCB">Ngân hàng Phương Đông (OCB)</option>
                <option value="KIENLONGBANK">Ngân hàng Kiên Long</option>
                <option value="VRB">Ngân hàng Việt Nga</option>
                <option value="NCB">Ngân hàng Quốc Dân</option>
                <option value="PGBANK">Ngân hàng PG bank</option>
                <option value="GPBANK">Ngân hàng GP Bank</option>
                <option value="VISA">Thẻ Visa</option>
                <option value="MASTERCARD">Thẻ Master Card</option>
                <option value="JCB">Thẻ JCB</option>
                <option value="APPOTA">Ví Appota</option>
            </select>
        </div>
    </form>
@endsection
...
@section('script')
    <script type="text/javascript">
        ...
        function submitOrder(el){
            if($("input[value='vnpay']").is(":checked")){
                if (!$('#OrderDescription').val()){
                    AIZ.plugins.notify('danger','Vui lòng nhập nội dung thanh toán');
                    return false;
                }

                if (!$('#bankcode').val()){
                    AIZ.plugins.notify('danger','Vui lòng chọn ngân hàng thanh toán');
                    return false;
                }
            }
            if($("input[value='appotapay']").is(":checked")){
                if (!$('#OrderDescriptionAppotaPay').val()){
                    AIZ.plugins.notify('danger','Vui lòng nhập nội dung thanh toán');
                    return false;
                }

                if (!$('#paymentMethodAppotaPay').val()){
                    AIZ.plugins.notify('danger','Vui lòng chọn phương thức thanh toán');
                    return false;
                }

                if (!$('#bankCodeAppotaPay').val()){
                    AIZ.plugins.notify('danger','Vui lòng chọn ngân hàng thanh toán');
                    return false;
                }
            }
        ...
        function toggleManualPaymentData(id) {
            let _other_payment_description = $('#other_payment_description');
            _other_payment_description.empty();

            if (id == 'vnpay') {
                $('#manual_payment_description').parent().removeClass('d-none');
                _other_payment_description.parent().removeClass('d-none');
                _other_payment_description.html($('#frmCreateOrderVNPay').html());
            }

            if (id == 'appotapay') {
                $('#manual_payment_description').parent().removeClass('d-none');
                _other_payment_description.parent().removeClass('d-none');
                _other_payment_description.html($('#frmCreateOrderAppotaPay').html());
            }
