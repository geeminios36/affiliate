    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                @if(get_setting('system_logo_white') != null)
                    <img class="mw-100" src="{{ uploaded_asset_logo(get_setting('system_logo_white')) }}"
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <!-- Sale -->
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('delivery.partner')}}"
                               class="aiz-side-nav-link {{ areActiveRoutes(['delivery.partner'])}} {{ areActiveRoutes(['delivery.partner.shippers'])}}">
                                <span class="aiz-side-nav-text">{{translate('Delivery Partner')}}</span>
                            </a>
                        </li>
                        {{--                        <li class="aiz-side-nav-item">--}}
                ...
                <li class="aiz-side-nav-item">
                    ...
                    @if(!empty($market))
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{route('market_place.index')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">Tổng quan</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
            ...
            <!-- Staffs -->
                ...
                @endif
                @if((Auth::user()->user_type == 'admin' || in_array('24', json_decode(Auth::user()->staff->role->permissions))) && is_main_tenacy())
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-user-tie aiz-side-nav-icon"></i>
            ...
            <!-- Addon Manager -->
                @if((Auth::user()->user_type == 'admin' || in_array('21', json_decode(Auth::user()->staff->role->permissions))) && is_main_tenacy())
                    <li class="aiz-side-nav-item">
