<div class="aiz-user-sidenav-wrap pt-4 position-relative z-1 shadow-sm">
    <div class="absolute-top-right d-xl-none">
        <button class="btn btn-sm p-2" data-toggle="class-toggle"
    ...
    <div class="aiz-user-sidenav rounded overflow-hidden  c-scrollbar-light">
            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                @if (Auth::user()->user_type == 'delivery_boy')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('assigned-deliveries') }}"
                            ...
                            <i
                                class="las la-hourglass-half aiz-side-nav-icon"></i>
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('pickup-deliveries') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['completed-delivery']) }}">
                            <i
                                class="las la-luggage-cart aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('completed-deliveries') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['completed-delivery']) }}">
                            <i
                                class="las la-check-circle aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('cancelled-deliveries') }}"
                            ...
                            <i
                                class="las la-times-circle aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('total-collection') }}"
                            ...
                            <i
                                class="las la-comment-dollar aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">
                ...
                @else
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('purchase_history.index') }}"
                            ...
                            <span
                                class="aiz-side-nav-text">{{ translate('Purchase History') }}</span>
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('digital_purchase_history.index') }}"
                            ...
                            <span
                                class="aiz-side-nav-text">{{ translate('Downloads') }}</span>
                        </a>
                    </li>
                    ...
                    @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customer_refund_request') }}"
                                ...
                                <span
                                    class="aiz-side-nav-text">{{ translate('Sent Refund Request') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('wishlists.index') }}"
                            ...
                            <span
                                class="aiz-side-nav-text">{{ translate('Wishlist') }}</span>
                        </a>
                    </li>
                    ...
                    @if (Auth::user()->user_type == 'seller')
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('product_bulk_upload.index') }}"
                                ...
                                <span
                                    class="aiz-side-nav-text">{{ translate('Product Bulk Upload') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                    ...
                    @if (Auth::user()->user_type == 'seller')
                        @if (
                            ...
                            @if (
                                \App\BusinessSetting::where('type', 'pos_activation_for_seller')->first() !=
                                    null && get_setting('pos_activation_for_seller') != 0)
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('poin-of-sales.seller_index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['poin-of-sales.seller_index']) }}">
                                        <i
                                            class="las la-fax aiz-side-nav-icon"></i>
                                        <span
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('orders.index') }}"
                                ...
                                <i
                                    class="las la-money-bill aiz-side-nav-icon"></i>
                                <span
                                    class="aiz-side-nav-text">{{ translate('Orders') }}</span>
                                @if ($orders > 0)
                                    <span
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('vendor_refund_request') }}"
                                    ...
                                    <i
                                        class="las la-backward aiz-side-nav-icon"></i>
                                    <span
                                        class="aiz-side-nav-text">{{ translate('Received Refund Request') }}</span>
                                </a>
                            </li>
                        @endif
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('reviews.seller') }}"
                                ...
                                <i
                                    class="las la-star-half-alt aiz-side-nav-icon"></i>
                                <span
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('shops.index') }}"
                                ...
                                <span
                                    class="aiz-side-nav-text">{{ translate('Shop Setting') }}</span>
                            </a>
                        </li>
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('payments.index') }}"
                                ...
                                <i
                                    class="las la-history aiz-side-nav-icon"></i>
                                <span
                                    class="aiz-side-nav-text">{{ translate('Payment History') }}</span>
                            </a>
                        </li>
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('withdraw_requests.index') }}"
                                ...
                                <i
                                    class="las la-money-bill-wave-alt aiz-side-nav-icon"></i>
                                <span
                                    class="aiz-side-nav-text">{{ translate('Money Withdraw') }}</span>
                            </a>
                        </li>
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('commission-log.index') }}"
                                ...
                                <i
                                    class="las la-file-alt aiz-side-nav-icon"></i>
                                <span
                    ...
                    @if (get_setting('conversation_system') == 1)
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('conversations.index') }}"
                                ...
                                <i
                                    class="las la-comment aiz-side-nav-icon"></i>
                                <span
                                    class="aiz-side-nav-text">{{ translate('Conversations') }}</span>
                                @if (count($conversation) > 0)
                                    <span
                                        class="badge badge-success">({{ count($conversation) }})</span>
                                @endif
                            </a>
                        </li>
                    @endif
                    ...
                    @if (get_setting('wallet_system') == 1)
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('wallet.index') }}"
                                ...
                                <i
                                    class="las la-dollar-sign aiz-side-nav-icon"></i>
                                <span
                                    class="aiz-side-nav-text">{{ translate('My Wallet') }}</span>
                            </a>
                        </li>
                    @endif
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('earnng_point_for_user') }}"
                                ...
                                <i
                                    class="las la-dollar-sign aiz-side-nav-icon"></i>
                                <span
                                    class="aiz-side-nav-text">{{ translate('Earning Points') }}</span>
                            </a>
                        </li>
                    @endif
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="javascript:void(0);"
                                ...
                                <i
                                    class="las la-dollar-sign aiz-side-nav-icon"></i>
                                <span
                                    class="aiz-side-nav-text">{{ translate('Affiliate') }}</span>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('affiliate.user.index') }}"
                                        class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('Affiliate System') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('support_ticket.index') }}"
                            ...
                            <span
                                class="aiz-side-nav-text">{{ translate('Support Ticket') }}</span>
                            @if ($support_ticket > 0)
                                <span
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('profile') }}"
                        ...
                        <span
                            class="aiz-side-nav-text">{{ translate('Manage Profile') }}</span>
                    </a>
                </li>
        ...
        @if (Auth::user()->user_type == 'seller')
            <hr>
            <h4 class="h5 fw-600 text-center">{{ translate('Sold Amount') }}
            </h4>
            ...
            <div class="widget-balance pb-3 pt-1">
                <div class="text-center">
                    <div class="heading-4 strong-700 mb-4">
                        @php
                            $orderTotal = \App\Order::where('seller_id', Auth::user()->id)
                        ...
                        <span
                            class="btn btn-primary fw-600 fs-18">{{ single_price($orderTotal) }}</span>
                    </div>
