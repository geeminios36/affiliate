...
@foreach ($mergeProducts as $product)
    ...
    @endphp
    <div class="product-modal-box modal fade"
        id="product-modal-{{ $product->id }}" tabindex="-1" role="dialog">
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-bs-dismiss="modal"
                        aria-label="Close"><span class="icon-cross"
                ...
                <div class="modal-body container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div
                                class="product-details-content quickview-content-wrap ">
                                ...
                                <h3 class="price">
                                    ...
                                    @if (home_base_price($product) != home_discounted_base_price($product))
                                        - <span class="old-price">
                                            {{ home_base_price($product) }}</span>
                                    @endif
                                </h3>

                                <div
                                    class="stock {{ $qty > 0 ? 'in-stock' : '' }} mt-10">
                                    <p>Available:
                                        <span>{{ $qty > 0 ? 'In stock' : 'Out of stock' }}</span>
                                    </p>
                                </div>
                                    ...
                                    <div class="quickview-cart-box">
                                        <div class="quickview-quality">
                                            <div class="cart-plus-minus">
                                                <input
                                                    class="cart-plus-minus-box cart-plus-minus-box-{{ $product->id }}"
                                                    type="text"
                                                    name="qtybutton"
                                                    value="0">
                                            </div>
                                        ...
                                        <div class="quickview-button">
                                            ...
                                            <div
                                                class="quickview-wishlist button">
                                ...
                                <div class="product_meta mt-30">
                                    ...
                                    <div class="tagged_as item_meta">
                                        <span class="label">Tag: </span><a
                                            href="#">Pottery</a>
                                    </div>
                                </div>

                                <div
                                    class="product_socials section-space--mt_60">
                                    <span class="label">Share this items
                                        :</span>
                                    <ul
                                        class="helendo-social-share socials-inline">
                                        <li>
                                            <a class="share-twitter helendo-twitter"
                                                href="#"
                                                target="_blank"><i
                                        ...
                                        <li>
                                            <a class="share-google-plus helendo-google-plus"
                                                href="#"
                                                target="_blank"><i
                                                    class="social_googleplus"></i></a>
                                        </li>
                                        <li>
                                            <a class="share-pinterest helendo-pinterest"
                                                href="#"
                                                target="_blank"><i
                                                    class="social_pinterest"></i></a>
                                        </li>
                                        <li>
                                            <a class="share-linkedin helendo-linkedin"
                                                href="#"
                                                target="_blank"><i
