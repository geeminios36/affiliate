...
@section('panel_content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ static_asset('download/product_bulk_demo.xlsx') }}" download>
                <button class="btn btn-primary mt-2">{{translate('Download CSV') }}</button>
            </a>
        </div>
    </div>
