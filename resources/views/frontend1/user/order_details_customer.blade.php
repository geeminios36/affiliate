<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">{{ translate('Order id') }}:
        {{ $order->code }}</h5>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="w-50 fw-600">{{ translate('Customer') }}:
                            </td>
                ...
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>{{ translate(ucfirst(str_replace('_', ' ', $status))) }}
                            </td>
                        </tr>
                        <tr>
                            <td class="w-50 fw-600">
                        ...
                        @if (get_setting('proxypay') == 1 && !$order->proxy_cart_reference_id->isEmpty())
                            <tr>
                                <td class="w-50 fw-600">
                                    {{ translate('Proxypay Reference') }}:</td>
                                <td>{{ $order->proxy_cart_reference_id->first()->reference_id }}
                                </td>
                            </tr>
                        @endif
                    </table>
