	...
	<div>
		...
		<div style="padding: 1rem;padding-bottom: 0">
            <table>
				...
				<tr><td class="strong">{{ isset($shipping_address->name) ? $shipping_address->name : $shipping_address->to_name }}</td></tr>
				<tr><td class="gry-color small">
                        {{ isset($shipping_address->address) ? $shipping_address->address : $shipping_address->to_address }},
                        {{ isset($shipping_address->city) ? $shipping_address->city : ($shipping_address->district.', '.$shipping_address->ward) }},
                        {{ @$shipping_address->country }}
                    </td>
                </tr>
				<tr><td class="gry-color small">{{translate('Email') }}: {{ @$shipping_address->email }}</td></tr>
				<tr><td class="gry-color small">{{translate('Phone') }}: {{ isset($shipping_address->phone) ? $shipping_address->phone : $shipping_address->to_phone }}</td></tr>
			</table>
		</div>
