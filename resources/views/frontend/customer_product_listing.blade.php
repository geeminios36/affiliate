                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            @else
                                                ...
                                                @foreach (\App\Utility\CategoryUtility::get_immediate_children_ids($category_id) as $key => $id)
                                                    <li class="ml-4 mb-2">
                                                        <a class="text-reset fs-14" href="{{ route('customer_products.category', \App\Category::where('id', $id)->first()->slug) }}">{{ \App\Category::where('id', $id)->first()->getTranslation('name') }}</a>
                                                    </li>
                                                @endforeach
                                            @endif
                                        </ul>
