                                ...
                                <div class="aiz-pos-product-list c-scrollbar-light">
                                    ...
                                    <div id="load-more">
                                        <p class="text-center fs-14 fw-600 p-2 bg-soft-primary c-pointer"
                                           onclick="loadMoreProduct()">{{translate('Load More') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <select name="user_id"
                                                class="form-control form-control-sm pos-customer aiz-selectpicker"
                                            ...
                                            @foreach (\App\Customer::all() as $key => $customer)
                                                @if ($customer->user)
                                                    <option value="{{ $customer->user->id }}"
                                                            data-contact="{{ $customer->user->email }}">{{ $customer->user->name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="text-center">
                                                        <img src="{{ asset('img/nothing-found.jpg') }}" class="img-fit"
                                                             height="150">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex">
                                    <div class="dropdown mr-3 dropup">
                                        <button class="btn btn-outline-primary btn-styled dropdown-toggle" type="button"
                                                data-toggle="dropdown">
                                            {{translate('Shipping')}}
                                        </button>
                                        <div class="dropdown-menu p-3 dropdown-menu-lg">
                                            <div class="radio radio-inline">
                                                <input type="radio" name="shipping" id="radioExample_2a" value="0"
                                                       checked onchange="setShipping()">
                                                <label
                                                    for="radioExample_2a">{{translate('Without Shipping Charge')}}</label>
                                            </div>
                                            ...
                                            <div class="radio radio-inline">
                                                ...
                                                <label
                                                    for="radioExample_2b">{{translate('With Shipping Charge')}}</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="">
                                    <button type="button" class="btn btn-styled btn-success"
                                            data-target="#order-confirm"
            ...
            <div class="modal-content" id="variants">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="submitOrder('cash')"
                            class="btn btn-primary">{{translate('Comfirm Order')}}</button>
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function getShippingAddress() {
            $.post('{{ route('pos.getShippingAddressForSeller') }}', {
                _token: '{{ csrf_token() }}',
