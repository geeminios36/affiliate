            ...
            <ul class="minicart-list">
                <li class="minicart-product">
                    ...
                    <a class="product-item_img">
                        <img class="img-fluid" src="assets/frontend/images/product/small/cart-01.webp" alt="Product Image">
                    </a>
                ...
                <li class="minicart-product">
                    <a class="product-item_remove" href="javascript:void(0)"><i class="icon-cross2"></i></a>
                    <a class="product-item_img">
                        <img class="img-fluid" src="assets/frontend/images/product/small/cart-02.webp" alt="Product Image">
                    </a>
                    <div class="product-item_content">
                ...
                <li class="minicart-product">
                    <a class="product-item_remove" href="javascript:void(0)"><i class="icon-cross2"></i></a>
                    <a class="product-item_img">
                        <img class="img-fluid" src="assets/frontend/images/product/small/cart-03.webp" alt="Product Image">
                    </a>
                    <div class="product-item_content">
