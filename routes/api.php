...
Route::middleware(['cors'])->group(function () {
    ...
    Route::prefix('v1')->group(function () {
        ...
        Route::post('carts/empty/{id}', 'Api\CartController@destroy')->middleware('auth:api');
        ...
        Route::get('tenacy/get-info-site-by-tenacyId', 'Api\TenacyController@getInfoSiteByTenacy');
    });
    ...
    Route::prefix('v2')->group(function () {
        ...
        Route::post('carts/empty/{id}', 'Api\V2\CartController@destroy')->middleware('auth:api');
        ...
        Route::post('user/info/tenacy_id', 'Api\V2\UserController@updateUserByTenacyId');
