...
@endif
@php
    $customer_package = \App\CustomerPackage::where('id', Session::get('payment_data')['customer_package_id'])->first();
@endphp
...
<script>
        ...
        function pay3() {
         Voguepay.init({
             ...
             cur: '{{\App\Currency::where('id',get_setting('system_default_currency'))->first()->value)->first()->code}}',
             merchant_ref: 'ref123',
