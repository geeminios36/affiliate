            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th>{{ translate('Requester Info') }}</th>
                        <th data-breakpoints="lg">
                            {{ translate('Total Amount to Pay') }}</th>
                ...
                <tbody>
                    @foreach ($seller_withdraw_requests as $key => $seller_withdraw_request)
                        @if (
                            \App\Seller::find($seller_withdraw_request->user_id) != null &&
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (\App\Seller::find($seller_withdraw_request->user_id) != null)
                                        ...
                                        <p>
                                            {{ \App\Seller::find($seller_withdraw_request->user_id)->user->email }}
                                        </p>
                                        <p>
                                            {{ \App\Seller::find($seller_withdraw_request->user_id)->user->phone }}
                                        </p>
                                    @endif
                                </td>
                                ...
                                <td>
                                    {{ get_type_seller_withdraw_requests($seller_withdraw_request->type) }}
                                </td>
                            </tr>
                        @endif
                    @endforeach
