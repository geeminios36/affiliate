        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th data-breakpoints="lg">{{translate('Enabled')}}</th>
			...
			<td>{{ $category->level }}</td>
                        ...
                        <td>
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" onchange="update_enabled(this)" value="{{ $category->id }}" <?php if($category->enabled == 1) echo "checked";?>>
                                <span></span>
                            </label>
                        </td>
...
@section('script')
    <script type="text/javascript">
        ...
        function update_enabled(el){
            ...
            $.post('{{ route('categories.enabled') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
