...
<div id="market-place-wrapper">
    <div id="market-place-content" style="margin-top: 4px;">
        <div class="sapo-product-wrapper">
            <div class="d-flex align-items-center justify-content-between sapo-product-header"><span class="header">Danh sách sản phẩm </span>
                <div class="d-flex">
                    <button type="button" class="btn instant-link" onclick="_modalChoiceMarket()">Liên kết nhanh
                    </button>
                    <button class="btn btn-primary " type="button" data-tip="true"
                            data-for="btn-sapo-product-syncing" onclick="_syncingProducts()"
                            style="opacity: 1; cursor: pointer;">Cập nhật dữ
                        liệu sản phẩm
                    </button>
                </div>
            </div>
            <div class="sapo-product-container">
                <div class="sapo-product-filter-container">
                    <div class="filter-advance-container">
                        <div class="filter-advance-wrapper">
                            <div class="d-flex align-items-center">
                                <div class="position-relative filter-by-options">
                                    <div class="position-relative text-center filter-text" role="presentation"
                                         onclick="filterText()">Lọc
                                        sản phẩm
                                        <svg width="7" height="5" viewBox="0 0 7 5" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.42859 0L3.2143 5L1.7643e-05 0L6.42859 0Z"
                                                  fill="#212B35"></path>
                                        </svg>
                                    </div>
                                </div>
                                <div class="position-relative filter-by-query">
                                    <div class="position-absolute search-icon">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            ...
                                            <path d="M15.75 15.75L12.4875 12.4875" stroke="#B1B1B1" stroke-width="2"
                                                  stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </div>
                                    <input placeholder="Tìm kiếm sản phẩm" value="{{$keyword}}" id="generalSearch">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="filter-identifier"></div>
                </div>
                <div class="sapo-product-list-container">
...
@include('backend.market-place.product_affiliate.affiliate_product_js')
