                    ...
                    <div class="card shadow-sm border-0 rounded">
                        <div class="card-body">
                            <div class="text-center py-4 mb-4">
                                <i
                                    class="la la-check-circle la-3x text-success mb-3"></i>
                                <h1 class="h3 mb-3 fw-600">
                                    {{ translate('Thank You for Your Order!') }}
                                </h1>
                                <h2 class="h5">{{ translate('Order Code:') }}
                                    <span
                            ...
                            <div class="mb-4">
                                <h5 class="fw-600 mb-3 fs-17 pb-2">
                                    {{ translate('Order Summary') }}</h5>
                                <div class="row">
                                    <div class="col-md-6">
                                        <table class="table">
                                            <tr>
                                    ...
                                    <div class="col-md-6">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>{{ date('d-m-Y H:i A', $order->date) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="w-50 fw-600">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ translate('Flat shipping rate') }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="w-50 fw-600">
                                    ...
                                    <table class="table table-responsive-md">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ translate('Variation') }}
                                                </th>
                                                <th>{{ translate('Quantity') }}
                                                </th>
                                                <th>{{ translate('Delivery Type') }}
                                                </th>
                                                <th class="text-right">
                                                    {{ translate('Price') }}</th>
                                            </tr>
