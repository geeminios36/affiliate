<!-- Modal -->
<div class="header-login-register-wrapper modal fade" id="example" tabindex="-1"
                ...
                <div class="tab-content content-modal-box">
                    <div class="tab-pane fade show active" id="tab_list_06"
                        ...
                        <form action="#" class="account-form-box">
                            ...
                            <div class="button-box mt-25">
                                <a href="#"
                                    class="btn btn--full btn--black">Log in</a>
                            </div>
                        </form>
                    </div>
                    <div class="tab-pane fade" id="tab_list_07" role="tabpanel">
                        ...
                        <form action="#" class="account-form-box">
                            ...
                            <div class="button-box mt-25">
                                <a href="#"
                                    class="btn btn--full btn--black">Register</a>
                            </div>
                        </form>
                    </div>
...
<!-- Modal -->
<div class="header-login-register-wrapper modal fade" id="exampleModal"
        ...
        <div class="modal-content">
            <div class="modal-box-wrapper">
                ...
                <div class="tab-content content-modal-box">
                    ...
                    <div class="tab-pane fade" id="tab_list_07"
                        role="tabpanel">
                        ...
                        <form action="#" class="account-form-box">
                            ...
                            <p class="mt-15">Your personal data will be used
                                to support your experience throughout this
                                website, to manage access to your account, and
                                for other purposes described in our <a
                                    href="#" class="privacy-policy-link"
                                    target="_blank">privacy policy</a>.</p>
