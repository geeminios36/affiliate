...
class AffiliateController extends Controller
{
    ...
    public function config_store(Request $request){
        ...
        $affiliate_config->tenacy_id = get_tenacy_id_for_query();
    ...
    public function store_affiliate_user(Request $request){
        ...
        $affiliate_user->tenacy_id = get_tenacy_id_for_query();
    ...
    {
        $affiliate_user = AffiliateUser::where('id', $request->id)->first();
    ...
    public function payment_store(Request $request){
        ...
        $affiliate_payment->tenacy_id = get_tenacy_id_for_query(); $affiliate_payment->save();

        $affiliate_user = AffiliateUser::where('id', $request->affiliate_user_id)->first();
        $affiliate_user->balance -= $request->amount;
        $affiliate_user->tenacy_id = get_tenacy_id_for_query(); $affiliate_user->save();
    ...
    public function payment_history($id){
        $affiliate_user = AffiliateUser::where('id', decrypt($id))->first();
            ...
            if(AffiliateOption::where('type', 'user_registration_first_purchase')->first()->status){
                if ($order->user != null && $order->user->orders->count() == 1) {
                    if($order->user->referred_by != null){
                        $user = User::where('id', $order->user->referred_by)->first();
                        if ($user != null) {
...
//        }
    ...
    public function withdraw_request_store(Request $request)
    {
        ...
        $withdraw_request->tenacy_id = get_tenacy_id_for_query();
    ...
    {
        $affiliate_withdraw_request = AffiliateWithdrawRequest::where('id', $request->id)->first();
    ...
    public function withdraw_request_payment_store(Request $request){
        ...
        if ($request->has('affiliate_withdraw_request_id')) {
            $affiliate_withdraw_request = AffiliateWithdrawRequest::where('id', $request->affiliate_withdraw_request_id)->first();
    ...
    {
        $affiliate_withdraw_request = AffiliateWithdrawRequest::where('id', $id)->first();
        $affiliate_withdraw_request->status = 2;
        $affiliate_withdraw_request->tenacy_id = get_tenacy_id_for_query();
